...
//use app\themes\devoops\Components\Navbar;
//use app\themes\devoops\Components\Menu;
//use app\themes\devoops\Components\Breadcrumbs;
use jucksearm\theme\devoops\AppAsset;
	...
	<div class="container-fluid expanded-panel">
	  <div class="row">
		<div id="logo" class="col-xs-12 col-sm-2">
		  <a href="index.html">
		    <img src="<?php echo $bundle->baseUrl;?>/img/logo-220.png" class="menu-logo" alt="Easy2Pay" />
		  </a>
		</div>
						...
						<ul class="nav navbar-nav pull-right panel-menu">
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle account" data-toggle="dropdown">
									<div class="avatar">
										<img src="<?php echo $bundle->baseUrl;?>/img/avatar.png" class="img-circle" alt="avatar" />
									</div>
